...
```{r 2.2}
## don't run this
setwd("/Users/kojiro/Desktop/qbio490/qbio_490_KainingFeng") # (ex: "/Users/nicoleblack/Desktop/qbio_490_nicole/week3_R")
...
```{r setup Exercise 2.3}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("/Users/kojiro/Desktop/qbio490/qbio_490_KainingFeng")) 
```
...
factor <- factor("male", "female","male","male")
factor
```
...
age <- 20
birthday <- 09/07/2002
three_favorite_color <- c("red", "yellow", "green")
name; age; birthday; three_favorite_color
typeof(name)
typeof(age)
typeof(birthday)
typeof(three_favorite_color)
```
...
my_vector <- 5
ifelse(my_vector>3, print(">3"), print("<3")) # where x happens if the expression is true, and y happens if it is false
